                ...
                value: function open(id) {
                    ...
                    if (!this._options.alwaysOpen) {
                        this._items.map(function (i) {
                            if (i !== item) {
                                var _i$triggerEl$classLis,
                                    _i$triggerEl$classLis2;

                                (_i$triggerEl$classLis =
                                    i.triggerEl.classList).remove.apply(
                                    _i$triggerEl$classLis,
                                    _toConsumableArray(
                                        _this2._options.activeClasses.split(' ')
                                    )
                                );

                                (_i$triggerEl$classLis2 =
                                    i.triggerEl.classList).add.apply(
                                    _i$triggerEl$classLis2,
                                    _toConsumableArray(
                    ...
                    (_item$triggerEl$class =
                        item.triggerEl.classList).add.apply(
                        _item$triggerEl$class,
                        _toConsumableArray(
                    ...
                    (_item$triggerEl$class2 =
                        item.triggerEl.classList).remove.apply(
                        _item$triggerEl$class2,
                        _toConsumableArray(
                ...
                value: function _init() {
                    ...
                    if (this._triggerEl) {
                        if (this._triggerEl.hasAttribute('aria-expanded')) {
                            ...
                            this._visible = this._targetEl.classList.contains(
                                'hidden'
                            )
                                ? false
                                : true;
                    ...
                    if (this._indicators.length) {
                        ...
                        this._indicators.map(function (indicator) {
                            ...
                            (_indicator$el$classLi =
                                indicator.el.classList).remove.apply(
                                _indicator$el$classLi,
                            ...
                            (_indicator$el$classLi2 =
                                indicator.el.classList).add.apply(
                                _indicator$el$classLi2,
                                carousel_toConsumableArray(
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document
            ...
            .forEach(function (carouselEl) {
                ...
                if (
                    carouselEl.querySelectorAll('[data-carousel-item]').length
                ) {
                    carousel_toConsumableArray(
...
*/
                ...
                value: function _createBackdrop() {
                    if (this._isHidden) {
                        ...
                        (_backdropEl$classList =
                            backdropEl.classList).add.apply(
                            _backdropEl$classList,
                            modal_toConsumableArray(
    ...
    /* harmony default export */ const modal = Modal; // CONCATENATED MODULE: ./src/components/tabs.js
        ...
        tabs_createClass(Tabs, [
            ...
            },
            {
                ...
                value: function show(id) {
                    ...
                    this._items.map(function (t) {
                        if (t !== tab) {
                            ...
                            (_t$triggerEl$classLis =
                                t.triggerEl.classList).remove.apply(
                                _t$triggerEl$classLis,
                            ...
                            (_t$triggerEl$classLis2 =
                                t.triggerEl.classList).add.apply(
                                _t$triggerEl$classLis2,
                                tabs_toConsumableArray(
                                    _this2._options.inactiveClasses.split(' ')
                                )
                    ...
                    (_tab$triggerEl$classL2 =
                        tab.triggerEl.classList).remove.apply(
                        _tab$triggerEl$classL2,
                        tabs_toConsumableArray(
                            this._options.inactiveClasses.split(' ')
                        )
    ...
    /* harmony default export */ const tooltip = Tooltip; // CONCATENATED MODULE: ./src/flowbite.js
    // core components
